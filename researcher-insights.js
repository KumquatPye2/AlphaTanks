...
class ResearcherInsights {
    ...
    updateMetricsDisplay() {
        ...
        metricsDiv.innerHTML = `
            <div class="metric">🧬 Genomes Generated<span class="module-tooltip" title="Genomes Generated tracks the total number of tank behavioral architectures created by the Researcher module. Each genome represents a unique combination of traits like aggression, speed, accuracy, defense, teamwork, adaptability, learning, risk-taking, and evasion. Higher numbers indicate more active genetic diversity generation." style="cursor: help; color: #888; margin-left: 3px; font-size: 8px;">❓</span>: ${this.metrics.genomeGenerations}</div>
            <div class="metric">🔀 Mutations<span class="module-tooltip" title="Mutations counts the number of genetic modifications applied to tank genomes. Mutations introduce random variations to behavioral traits, creating genetic diversity essential for evolution. Each mutation can potentially discover new successful strategies or improve existing ones." style="cursor: help; color: #888; margin-left: 3px; font-size: 8px;">❓</span>: ${this.metrics.mutations}</div>
            <div class="metric">🔗 Crossovers<span class="module-tooltip" title="Crossovers tracks how many times parent genomes have been combined to create offspring. This genetic recombination mixes successful traits from different parents, potentially creating superior combinations and is a key mechanism for evolutionary progress." style="cursor: help; color: #888; margin-left: 3px; font-size: 8px;">❓</span>: ${this.metrics.crossovers}</div>
            <div class="metric">🏆 Tournaments<span class="module-tooltip" title="Tournaments counts the number of selection events where multiple candidates compete for the right to become parents. Tournament selection applies evolutionary pressure by favoring fitter individuals, driving the evolution toward better-performing strategies." style="cursor: help; color: #888; margin-left: 3px; font-size: 8px;">❓</span>: ${this.metrics.tournaments}</div>
            <div class="metric">🧪 Experiments<span class="module-tooltip" title="Experiments tracks the number of complete research cycles where the Researcher proposes new architectures for both teams. Each experiment represents a full generation of genetic algorithm operations including selection, crossover, and mutation for competitive evolution." style="cursor: help; color: #888; margin-left: 3px; font-size: 8px;">❓</span>: ${this.metrics.experiments}</div>
            <div class="metric">⚔️ Red Queen Adaptations<span class="module-tooltip" title="Red Queen Adaptations counts instances where teams adapt their strategies in response to opponent behavior. Named after the Red Queen hypothesis, this tracks competitive coevolution where each team must continuously evolve to maintain effectiveness against the other team's evolving strategies." style="cursor: help; color: #888; margin-left: 3px; font-size: 8px;">❓</span>: ${this.metrics.redQueenAdaptations}</div>
        `;
    }
    updateLogsDisplay() {
