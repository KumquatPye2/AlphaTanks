...
class ASIArchIntegration {
    constructor() {
        ...
        console.log(`ASI-ARCH Integration initialized. LLM features: ${this.isEnabled ? 'ENABLED' : 'DISABLED'}`);
    ...
    async processBattleResult(redTeam, blueTeam, battleResult) {
        ...
        console.log('Processing battle with LLM-enhanced ASI-ARCH...');
        ...
        try {
            ...
            console.error('LLM-enhanced processing failed:', error);
            return this.processBasicResult(redTeam, blueTeam, battleResult);
        }
    }
    ...
    enableLLMFeatures() {
        ...
        console.log('LLM features enabled');
    ...
    enableMockMode() {
        ...
        console.log('Mock mode enabled - API calls will be simulated');
    }
    ...
    disableMockMode() {
        ...
        console.log('Mock mode disabled - Real API calls will be used');
    }
}
...
function initializeASIArch() {
    if (!globalASIArchIntegration) {
        ...
        console.log('Global ASI-ARCH integration initialized');
