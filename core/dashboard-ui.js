...
class DashboardUI {
    ...
    updateMetricsDisplay() {
        ...
        metricsDiv.innerHTML = `
            <div class="metric-item">🧬 Genomes Generated: ${metrics.genomeGenerations}</div>
            <div class="metric-item">🔀 Mutations: ${metrics.mutations}</div>
            <div class="metric-item">🔗 Crossovers: ${metrics.crossovers}</div>
            <div class="metric-item">🏆 Tournaments: ${metrics.tournaments}</div>
