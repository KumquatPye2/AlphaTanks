...
class DataCollector {
    ...
    /**
     * Track scenario context for research documentation
     */
    trackScenarioContext(scenarioId, seed, researchContext) {
        this.metrics.scenarioContexts++;
        this.metrics.currentScenario = scenarioId;
        this.metrics.totalSeeds++;
        this.log('SCENARIO_CONTEXT', `Research Context: ${scenarioId} (seed: ${seed})`, {
            scenario: scenarioId,
            seed: seed,
            researchContext: researchContext || 'general_evolution',
            environmentType: this.classifyScenarioType(scenarioId),
            timestamp: Date.now()
        });
    }
    /**
    ...
    resetAll() {
        ...
        // Log the reset
        this.log('SYSTEM', 'Data collector reset - all metrics and history cleared', {
